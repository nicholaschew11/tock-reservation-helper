...
TOCK_RELEASE_AT="${TOCK_RELEASE_AT:-2026-06-19T20:00:00-07:00}"
TOCK_DATE="${TOCK_DATE:-2026-06-24}"
...
TOCK_LAUNCH_DAY="${TOCK_LAUNCH_DAY:-19}"
TOCK_LAUNCH_HOUR="${TOCK_LAUNCH_HOUR:-19}"
